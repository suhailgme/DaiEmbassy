	...
	render() {
		...
		return (
			<ChartCanvas height={490}
				...
				type={type}
				seriesName={`MKRUSD_${this.state.suffix}`}
				data={data}
				xScale={xScale}
				xAccessor={xAccessor}
			...
			<Chart id={1} yExtents={d => [d.high, d.low]}>
				...
				<EdgeIndicator itemType='last' orient='left' edgeAt='right' displayFormat={format("$.2f")}   fill={d => d.close > d.open ? "#6BA583" : "#FF0000"} yAccessor={d=> d.close}/>
