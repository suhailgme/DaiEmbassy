...
export default class SystemStatusWidget extends Component {
    ...
    onMouseOverLockedCollateral(e) {
        this.setState({
            displayLockedEth: !this.state.displayLockedEth,

        })
    }

    onMouseoutLockedCollateral(e) {
        this.setState({
            displayLockedEth: !this.state.displayLockedEth,
            ...
            <div>
                ...
                <Form>
                    <Grid columns='equal' padded='vertically'>
                        ...
                        <Grid.Row style={{ paddingTop: '0', paddingBottom: '5px', cursor: 'help' }} onMouseEnter={this.onMouseOverLockedCollateral.bind(this)} onMouseLeave={this.onMouseoutLockedCollateral.bind(this)} id='lockedCollateral'>
                            <Grid.Column textAlign='left' style={{ whiteSpace: 'nowrap', textDecoration: 'underline' }}>{this.state.displayLockedEth ? 'Locked ETH' : 'Locked PETH'}</Grid.Column>
                            <Grid.Column textAlign='right' style={{ whiteSpace: 'nowrap', color: this.state.displayLockedEth ? '#FF695E' : '#6abf69' }}>{this.state.displayLockedEth ? `${this.numberWithCommas(systemStatus.lockedEth)}` : `${this.numberWithCommas(systemStatus.lockedPeth)}`}</Grid.Column>
                        </Grid.Row>
                        <Grid.Row style={{ paddingTop: '0', paddingBottom: '5px' }}>
                            <Grid.Column textAlign='left' style={{whiteSpace: 'nowrap'}}>PETH/ETH Ratio</Grid.Column>
