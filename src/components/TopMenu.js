...
import { Menu, Icon, Label, Popup, Search } from 'semantic-ui-react'
    ...
    render(){
        ...
        return(
            <Menu fluid inverted stackable borderless attached size='huge' style={{marginBottom:'5px', backgroundColor:'#3D4853'}}>
                ...
                <Popup inverted position='right center' trigger={<Label color='red'>Alpha</Label>} content='Alpha 0.0.1'/></Menu.Item>
                <Menu.Item fluid inverted><Search fluid value={this.state.value} loading={this.state.isLoading} onSearchChange={this.handleSearchChange} onResultSelect={this.props.handleSearchClick} results = {this.state.results} size='mini'/></Menu.Item>
